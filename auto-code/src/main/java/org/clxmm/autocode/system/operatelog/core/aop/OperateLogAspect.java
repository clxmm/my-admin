package org.clxmm.autocode.system.operatelog.core.aop;
...
import org.clxmm.autocode.system.operatelog.enums.OperateTypeEnum;
import org.clxmm.autocode.system.security.util.SecurityUserUtil;
import org.clxmm.autocode.util.json.JsonUtils;
import org.clxmm.autocode.util.monitor.TracerUtils;
...
import static org.clxmm.autocode.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
import static org.clxmm.autocode.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    private void fillUserFields(OperateLogCreateReqDTO operateLogDTO) {
        Long id = SecurityUserUtil.getAdmin().getId();
        operateLogDTO.setUserId(id);
    }
    ...
    private static void fillMethodFields(OperateLogCreateReqDTO operateLogDTO,
        ...
        if (result != null) {
            if (result instanceof Result) {
                ...
                operateLogDTO.setResultCode(Integer.valueOf(commonResult.getCode()));
    ...
    private static void fillModuleFields(OperateLogCreateReqDTO operateLogDTO,
        ...
        if (operateLog != null && ArrayUtil.isNotEmpty(operateLog.type())) {
            operateLogDTO.setOperateType(operateLog.type()[0].getType());
        }
